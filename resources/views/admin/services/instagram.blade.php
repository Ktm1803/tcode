                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-inner">
                                <form action="{{ route('admin.service.add', 'instagram') }}" ajax-request="huycoder"
                                    method="POST">
                                    {{-- select --}}
                                ...
                                @foreach ($SubGiare as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($item->status_server == 'on')
                                                <a href="{{ route('admin.service.status', $item->id) }}"
                    ...
                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="type_service" id="type_service" class="form-select js-select2">
                                                <option value="like-instagram">Like bài viết</option>
                                                <option value="sub-instagram">Sub/follow</option>
                                            </select>
                                        </div>
                                    </div>
                    `);
                    ...
                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="type_service" id="type_service" class="form-select js-select2">
                                                ...
                                                <option value="comment-instagram">Comment instagram</option>
                                                <option value="view-instagram">View instagram</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
