...
<head>
    <meta charset="utf-8">
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e($site_config->getValueByName('favicon')); ?>" />
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <meta name="api-token" content="<?php echo e(Auth::user()->api_token); ?>">
    <meta name="description"
        content="<?php echo e($site_config->getValueByName('domain')); ?> là đơn vị hàng đầu Việt Nam chuyên cung cấp các dịch vụ seeding tăng Like, Share, Comment, Follow... cho các Mạng xã hội như Facebook, Instagram, Tiktok ...">
    <meta name="keywords"
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e($site_config->getValueByName('favicon')); ?>" />
    <!-- STYLE CSS -->
    <link href="<?php echo e(asset('')); ?>lqh/app.css" rel="stylesheet" />
    <link href="<?php echo e(asset('')); ?>lqh/jquery.dataTables.css" rel="stylesheet" />
...
<body class="main">
    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            <a href="<?php echo e(route('home')); ?>" class="flex mr-auto">
        ...
        <ul class="border-t border-theme-2 py-5 hidden" id="menu">
            <li>
                ...
                <ul class="" id="side-menu__choose-mobile">
                    <li>
                        <a href="<?php echo e(route('home')); ?>" class="menu">
                            <div class="menu__icon">
            ...
            <li>
                ...
                <ul class="" id="side-menu__choose-mobile">
                    <li>
                        <a href="<?php echo e(route('banking')); ?>" class="menu">
                            <div class="menu__icon">
                                <i data-feather="activity"></i>
                            </div>
            ...
            <?php if($site_config->getValueByName('subgiare') == 'show'): ?>
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon">
                            <img src="<?php echo e(asset('huycode/images/client/facebook.png')); ?>" alt="facebook"
                    ...
                    <ul class="">
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'like-sale')); ?>" class="menu">
                                        <div class="menu__icon">
                                ...
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'like-speed')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                                ...
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'like-comment')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'sub-vip')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                                ...
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'sub-quality')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                                ...
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'sub-sale')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                                ...
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'sub-speed')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'eye-live')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'comment-sale')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                                ...
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'comment-speed')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'share-profile')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'view-video')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                                ...
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'view-story')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.facebook-v2', 'member-group')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
            ...
            <?php if($site_config->getValueByName('subgiare') == 'show'): ?>
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon">
                            <img src="<?php echo e(asset('huycode/images/client/instagram.png')); ?>" alt="instagram"
                                width="30px" height="30px">
                        </div>
                    ...
                    <ul class="">
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.instagram-v2', 'like-post')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.instagram-v2', 'follow')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
            ...
            <?php if($site_config->getValueByName('subgiare') == 'show'): ?>
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon">
                            <img src="<?php echo e(asset('huycode/images/client/tiktok.png')); ?>" alt="tiktok" width="30px"
                                height="30px">
                        </div>
                    ...
                    <ul class="">
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.tiktok-v2', 'like')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.tiktok-v2', 'sub')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                                        <div class="menu__title"> Tăng Follow</div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.tiktok-v2', 'comment')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.tiktok-v2', 'view')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
                        ...
                        <li>
                            ...
                            <ul class="" id="side-menu__choose-mobile">
                                <li>
                                    <a href="<?php echo e(route('service.tiktok-v2', 'share')); ?>" class="menu">
                                        <div class="menu__icon">
                                            <i data-feather="zap"></i>
                                        </div>
            ...
            <li>
                <a href="javascript:;" class="menu">
                    <div class="menu__icon">
                        <img src="<?php echo e(asset('huycode/images/client/youtube.png')); ?>" alt="youtube" width="30px"
                            height="30px">
                    </div>
            ...
            <li>
                <a href="javascript:;" class="menu">
                    <div class="menu__icon">
                        <img src="<?php echo e(asset('huycode/images/client/twitter.png')); ?>" alt="twitter" width="30px"
                            height="30px">
                    </div>
            ...
            <li>
                <a href="javascript:;" class="menu">
                    <div class="menu__icon">
                        <img src="<?php echo e(asset('huycode/images/client/shopee.png')); ?>" alt="shopee" width="30px"
                            height="30px">
                    </div>
            ...
            <li>
                <a href="javascript:;" class="menu">
                    <div class="menu__icon">
                        <img src="<?php echo e(asset('huycode/images/client/telegram.png')); ?>" alt="telegram" width="30px"
                            height="30px">
                    </div>
            ...
            <li>
                <a href="javascript:;" class="menu">
                    <div class="menu__icon">
                        <img src="<?php echo e(asset('huycode/images/client/code.png')); ?>" alt="telegram" width="30px"
                            height="30px">
                    </div>
            ...
            <?php if(Auth::user()->level == 'admin'): ?>
                <li>
                    <a href="<?php echo e(route('admin.index')); ?>" class="menu">
                        <div class="menu__icon">
                            <img src="<?php echo e(asset('huycode/images/client/user (1).png')); ?>" alt="admin"
                                width="30px" height="30px">
                        </div>
    ...
    // }
    ?>
<?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/layouts/header.blade.php ENDPATH**/ ?>