                ...
                <div class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative">
                    <table id="dataTable" class=" table-responsive border-collapse bg-white cust-datatable no-footer"
                        ...
                        <tbody class="p-4">
                            ...
                            <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $huy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td style="text-align:center" class="p-4"><?php echo e($huy->id); ?></td>
                                    <td style="text-align:center"><?php echo e($huy->created_at); ?></td>
                                    
                                    <td style="text-align:center"><?php echo e($huy->transactionId); ?> </td>
                                    <td style="text-align:center"><?php echo e(number_format($huy->creditAmount)); ?></td>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/recharge/banking.blade.php ENDPATH**/ ?>