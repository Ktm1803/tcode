                    ...
                    <div
                        ...
                        <div class="intro-x mt-8">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Họ và tên" value="<?php echo e(Request::old('name')); ?>">
                            <input type="text" name="username" id="username"
                                class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4"
                                placeholder="Tên tài khoản" value="<?php echo e(Request::old('username')); ?>">
                            <input type="email" name="email" id="email"
                                class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4"
                                placeholder="Địa chỉ email" value="<?php echo e(Request::old('email')); ?>">
                            <input type="number" name="number" id="number"
                                class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4"
                                placeholder="Số điện thoại" value="<?php echo e(Request::old('number')); ?>">
                            <input type="text" name="fb_id" id="idpost" onchange="getIDPOST()"
                                class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4"
                                placeholder="Links Facebook của bạn" value="<?php echo e(Request::old('uid')); ?>">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <a class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top"
                                href="<?php echo e(route('auth.login')); ?>">Đăng Nhập</a>
                        </div>
                    </div>
                </div>
            </form>
...
<?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/auth/register.blade.php ENDPATH**/ ?>