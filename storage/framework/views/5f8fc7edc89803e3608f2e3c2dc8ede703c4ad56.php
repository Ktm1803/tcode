                    ...
                    <div class="col-md-4">
                        <div class="card border shadow-none">
                            <div class="card-body">
                                ...
                                <a href="<?php echo e(route('banking')); ?>" class="btn btn-label-primary d-grid w-100">Nạp
                                    ngay</a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Huycode\resources\views/pages/cap-bac.blade.php ENDPATH**/ ?>