                                ...
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        ...
                                        <div class="text-2xl font-medium leading-8 mt-4">
                                            ...
                                            <?php elseif(Auth::user()->level == 'DL'): ?>
                                                <span class="text-info">Đại lý</span>
                                            <?php elseif(Auth::user()->level == 'NPP'): ?>
                                                ...
                                                <div
                                                    ...
                                                    <div class="w-10 h-10 flex-none image-fit">
                                                        <img alt="Logo" class="rounded-full"
                                                            src="<?php echo e(asset('huycode/images/users/admin.png')); ?>">
                                                    </div>
                                                    <div class="ml-3 mr-auto">
                                                        ...
                                                        <div class="flex text-gray-600 truncate text-xs mt-0.5"><a
                                                                ...
                                                                class="mx-1">•</span><?php echo e($item->created_at); ?>
                                                ...
                                                <div
                                                    ...
                                                    <div class="intro-x flex mr-2">
                                                        <div class="intro-x w-8 h-8 image-fit">
                                                            <img alt="profile-1"
                                                                ...
                                                                src="<?php echo e(asset('huycode/images/users/gai1.jpg')); ?>"
                                                                title="Robert De Niro">
                                                        </div>
                                                        <div class="intro-x w-8 h-8 image-fit -ml-4">
                                                            <img alt="profile-2"
                                                                class="rounded-full border border-white zoom-in tooltip"
                                                                src="<?php echo e(asset('huycode/images/users/gai2.jpg')); ?>"
                                                                title="Denzel Washington">
                                                        </div>
                                                        <div class="intro-x w-8 h-8 image-fit -ml-4">
                                                            <img alt="profile-3"
                                                                class="rounded-full border border-white zoom-in tooltip"
                                                                src="<?php echo e(asset('huycode/images/users/gai3.jpg')); ?>"
                                                                title="Nicolas Cage">
                                                        </div>
                                                    </div>
                                                    <a href="https://www.facebook.com/lqh.coder"
                                                        ...
                                                        title="facebook"> <img alt="facebook"
                                                            class="rounded-full border border-white zoom-in tooltip"
                                                            src="<?php echo e(asset('huycode/images/users/facebook.png')); ?>"
                                                            title="Facebook"> </a>
                                                </div>
                                                    ...
                                                    <div class="w-full flex items-center mt-3">
                                                        ...
                                                        <div class="flex-1 relative text-gray-700">
                                                            ...
                                                            <img alt="send"
                                                                ...
                                                                src="<?php echo e(asset('huycode/images/users/telegram.png')); ?>"
                                                                title="Facebook">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            <div class="w-20 h-20 flex-none image-fit rounded-full overflow-hidden">
                                                <img alt="notifications"
                                                    src="<?php echo e(asset('huycode/images/users/notification.png')); ?>">
                                            </div>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/home.blade.php ENDPATH**/ ?>