                ...
                <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                        <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full"
                            src="<?php echo e(asset('huycode/images/users/user.png')); ?>">
                    </div>
                    <div class="ml-5">
                ...
                <div
                    ...
                    <div class="text-center rounded-md py-3 col-span-12 sm:col-span-6 xl:col-span-6">
                        <div class="font-medium text-theme-10 dark:text-theme-3 text-xl">
                            <?php echo e(number_format(Auth::user()->total_charge)); ?>
                        ...
                        <div class="p-1">
                            <div id="form-validation" class="p-5">
                                <div class="preview">
                                    ...
                                    <form class="validate-form" action="<?php echo e(route('change-password')); ?>"
                                        ...
                                        <div class="input-form mt-3">
                                            ...
                                            <input id="validation-form-2" type="text" name="balance" class="form-control"
                                                ...
                                                value="<?php echo e(number_format(Auth::user()->money)); ?>" readonly>
                                        </div>
                                        <div class="input-form mt-3">
                                            ...
                                            <input id="validation-form-3" type="email" name="email" class="form-control"
                                                placeholder="Địa chỉ email" value="<?php echo e(Auth::user()->email); ?>" readonly>
                                        </div>
                                        <div class="input-form mt-3">
                                            <label for="validation-form-3"
                                            ...
                                            <input id="validation-form-3" type="number" name="mobile" class="form-control"
                                                placeholder="Số điện thoại" value="<?php echo e(Auth::user()->number); ?>" readonly>
                                        </div>
                                        <div class="input-form mt-3">
                                            ...
                                            <input id="validation-form-4" type="text" name="fb_id" class="form-control"
                                                placeholder="Nhập links Facebook" value="<?php echo e(Auth::user()->fb_id); ?>"
                                                readonly>
                                        </div>
                                        <div class="input-form mt-3">
                        ...
                        <div class="p-4">
                            <div class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative">
                                <table id="dataTable"
                                    ...
                                    <tbody class="p-4">
                                        <?php $__currentLoopData = $listHuycode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td style="text-align:center" class="p-4"><?php echo e($item->id); ?></td>
                                                <td><?php echo e($item->content); ?></td>
                                                <td style="text-align:center"> <?php echo e(number_format(Auth::user()->money)); ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/pages/profile.blade.php ENDPATH**/ ?>