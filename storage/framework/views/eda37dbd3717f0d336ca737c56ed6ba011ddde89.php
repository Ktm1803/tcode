    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 pos">
                    ...
                    <div id="create" class="tab-pane box active mt-5" role="tabpanel" aria-labelledby="create-tab">
                        ...
                        <div id="form-validation" class="p-5 pt-2">
                            <div class="preview">
                                ...
                                <form class="validate-form" action="<?php echo e(route('api.service.facebook-v2', $type)); ?>"
                                    ajax-request="huycoder" method="POST">
                                    
                                    <?php if($type == 'like-sale' ||
                                        $type == 'like-speed' ||
                                        $type == 'comment-sale' ||
                                        $type == 'comment-speed' ||
                                        $type == 'eye-live' ||
                                    ...
                                    <?php if($type == 'sub-vip' || $type == 'sub-quality' || $type == 'sub-sale' || $type == 'sub-speed'): ?>
                                        <div class="input-form mt-3">
                                            <label for="validation-form-5"
                                    ...
                                    <?php if($type == 'like-page-quality' || $type == 'like-page-sale' || $type == 'like-page-speed'): ?>
                                        <div class="input-form mt-3">
                                            <label for="validation-form-5"
                                                class="form-label w-full flex flex-col sm:flex-row"> Links hoặc ID
                                    ...
                                    <?php if($type == 'comment-sale' || $type == 'comment-speed'): ?>
                                        <div class="input-form mt-3">
                                    ...
                                    <?php if($type == 'like-sale' || $type == 'like-speed' || $type == 'like-comment'): ?>
                                        <div class="input-form mt-3">
                                            <div class="row">
                                                <div class="col-md-3">
                                                ...
                                                flex-wrap: wrap;">
                                                    ...
                                                    custom-radio custom-control-inline mt-2">
                                                        ...
                                                        <label class="custom-control-label" for="reaction1">
                                                            <span class="badge bg-primary"><?php echo e(__('Like')); ?></span>
                                                        </label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline mt-2">
                                                        ...
                                                        <label class="custom-control-label" for="reaction2">
                                                            <span class="badge bg-primary"><?php echo e(__('Love')); ?></span>
                                                        </label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline mt-2">
                                                        ...
                                                        <label class="custom-control-label" for="reaction3">
                                                            <span class="badge bg-primary"><?php echo e(__('Haha')); ?></span>
                                                        </label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline mt-2">
                                                        ...
                                                        <label class="custom-control-label" for="reaction4">
                                                            <span class="badge bg-primary"><?php echo e(__('Wow')); ?></span>
                                                        </label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline mt-2">
                                                        ...
                                                        <label class="custom-control-label" for="reaction5">
                                                            <span class="badge bg-primary"><?php echo e(__('Sad')); ?></span>
                                                        </label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline mt-2">
                                                        ...
                                                        <label class="custom-control-label" for="reaction6">
                                                            <span class="badge bg-primary"><?php echo e(__('Angry')); ?></span>
                                                        </label>
                                                    </div>
                                                </div>
                                    ...
                                    <?php if($type == 'like-speed' || $type == 'like-comment'): ?>
                                        <div class="input-form mt-3">
                                            <label for="validation-form-6"
                                                class="form-label w-full flex flex-col sm:flex-row">
                                    ...
                                    <button type="submit"
                                        <?php if($type == 'comment-speed'): ?> show="Lưu ý số lượng sẽ bằng 1 comment xuống dòng nếu dòng đó không có gì vẫn sẽ tính là 1 nên các bạn cần lưu ý"
                                    <?php else: ?>
                                    show="Bạn có chắc chắn muốn mua đơn hàng này?" <?php endif; ?>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $listOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center"><?php echo e($item->type); ?></td>
                                                    <td style="text-align:left"><?php echo e($item->link_order); ?></td>
                                                    <td style="text-align:center"><?php echo e($item->server_order); ?></td>
                                                    <td style="text-align:center"><?php echo e($item->amount); ?></td>
            ...
            <?php if($type == 'like-sale' || $type == 'like-speed' || $type == 'like-comment'): ?>
                <div class="intro-y col-span-12 lg:col-span-4 bg-theme-7 p-2" style="border-radius: 5px">
                    <p style=""><span class="font-bold" style=""><b>
                                <font color="#ff0000"><?php echo e($title); ?> </font>
                            </b>&nbsp;</span>là gói <?php echo e($title); ?> giá rẻ tự động tăng Like mỗi khi bạn đăng bài viết
                    ...
                    <p style="">- Hệ thống tăng tối đa cho mỗi bài viết:&nbsp;<span class="font-bold text-danger"
                            style=""><b>2.000 Like</b></span>, tức gói <?php echo e($title); ?> cao nhất là:&nbsp;<span
            ...
            <?php if($type == 'sub-vip' || $type == 'sub-quality' || $type == 'sub-sale' || $type == 'sub-speed'): ?>
                <div class="intro-y col-span-12 lg:col-span-4 bg-theme-7 p-2" style="border-radius: 5px">
                    <p>
                        <font color="#ff0000"><b><?php echo e($title); ?></b></font>
                    </p>
                    ...
                    <p><span style="outline: none !important;"><b>
                                <font color="#ff0000">Đối với <?php echo e($title); ?> cho trang cá nhân yêu cầu cài đặt
                                    :&nbsp;</font>
                    ...
                    <p>+ Công khai : cài đặt -&gt; Quyền riêng tư -&gt; Ai có thể gửi cho bạn lời mời kết bạn (Mọi
                        người)&nbsp;</p>
                    <p><b>
                            <font color="#ff0000">NGHIÊM CẤM <?php echo e($title); ?> ĐỂU BÊN KHÁC XONG QUAY SANG BÊN MÌNH BUFF
                                TIẾP
                            </font>
                    ...
                    <p><b>
                            <font color="#ff0000">KHÔNG ĐƯỢC <?php echo e($title); ?> NHIỀU SERVER CÙNG LÚC </font>
                            <font color="#0000ff">-&gt;</font>
                ...
                <div class="intro-y col-span-12 lg:col-span-4 bg-theme-7 p-2" style="border-radius: 5px">
                    ...
                    <p style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; outline: none !important;"><span
                            style="outline: none !important;"><span
                                style="color: rgb(255, 0, 0); font-weight: 700;"><?php echo e($title); ?></span><br></span></p>
                    <p style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; outline: none !important;"><span
                    ...
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span style="outline: none !important;">-
                            hiện tại <?php echo e($title); ?> đang ổn định</span></p>
                </div>
            <?php endif; ?>
                ...
                <div class="intro-y col-span-12 lg:col-span-4 bg-theme-7 p-2" style="border-radius: 5px">
                    <p style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    ...
                                    <font color="#ff0000"><b> <?php echo e($title); ?></b></font><br>
                                </span></span></span></p>
                    <p style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"> <?php echo e($title); ?> do FB hạn chế nên đôi lúc sẽ
                                    thiếu
                    ...
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"><b>
                                        <font color="#0000ff"> <?php echo e($title); ?> loại 1</font>
                                    </b></span></span></span></p>
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"> <?php echo e($title); ?> không lên được trong nhóm vì
                                    tài khoản
                    ...
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"><b>
                                        <font color="#0000ff"> <?php echo e($title); ?> loại 2</font>
                                    </b></span></span></span></p>
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span style="outline: none !important;">+
                    ...
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"><b>
                                        <font color="#0000ff"> <?php echo e($title); ?> loại 3 ( lên nhanh )</font>
                                    </b></span></span></span></p>
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                    ...
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"><b>
                                        <font color="#0000ff"> <?php echo e($title); ?> loại 4 ( lên nhanh )</font>
                                    </b></span></span></span></p>
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                    ...
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span style="font-weight: bolder;">
                            <font color="#0000ff"> <?php echo e($title); ?> loại 5 ( bảo trì )</font>
                        </span></p>
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"><span style="font-weight: bolder;">
                                        <font color="#0000ff"> <?php echo e($title); ?> loại 6 ( lên nhanh )</font>
                    ...
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;"><span
                                    style="outline: none !important;"><span style="font-weight: bolder;">
                                        <font color="#0000ff"> <?php echo e($title); ?> loại 7 ( lên nhanh )</font>
                                    </span></span></span></span></p>
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span style="outline: none !important;">+
                            lên nhanh trong 5- 10 phút</span></p>
                    <p style="margin: 5px 0px 0px; outline: none !important;"><span style="outline: none !important;">+
                        ...
                        <span style="color: rgb(231, 76, 60); outline: none !important;"><span
                                style="outline: none !important;"><span
                                    style="font-weight: 700; outline: none !important;"><span
                                        style="color: rgb(255, 0, 0); font-family: &quot;Source Sans Pro&quot;, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;; font-size: 16px;"><?php echo e($title); ?></span><br></span></span></span>
                    </p>
                    <p style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; outline: none !important;"><span
                            style="outline: none !important;"><span style="outline: none !important;">
            ...
            <?php if($type == 'view-video' || $type == 'view-story'): ?>
                <div class="intro-y col-span-12 lg:col-span-4 bg-theme-7 p-2" style="border-radius: 5px">
                    <p style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; outline: none !important;"><span
                            style="outline: none !important;"><span
                                style="color: rgb(255, 0, 0); font-weight: 700;"><?php echo e($title); ?></span><br></span></p>
            ...
            <?php if($type == 'member-group'): ?>
                <div class="intro-y col-span-12 lg:col-span-4 bg-theme-7 p-2" style="border-radius: 5px">
                    ...
                    <p>
                        <font color="#ff0000"><span style="font-weight: bolder;">BUFF&nbsp; <?php echo e($title); ?></span>
                        </font>
                    </p>
                    <p>+ Tài nguyên clone nuôi có tương tác</p>
                    <p>+ Tùy lượng đơn mỗi ngày hệ thống có lúc nhanh - chậm&nbsp;</p>
                    ...
                    <p><span style="font-weight: bolder;">
                        ...
                        </span><span style="color: rgb(255, 0, 0); font-weight: 700;"><?php echo e($title); ?></span><span
        ...
        <?php $__env->startSection('script'); ?>
            <script>
                $(document).ready(function() {
                    var like = "<?php echo e(asset('huycode/images/service/like.png')); ?>";
                    var love = "<?php echo e(asset('huycode/images/service/love.png')); ?>";
                    var haha = "<?php echo e(asset('huycode/images/service/haha.png')); ?>";
                    var wow = "<?php echo e(asset('huycode/images/service/wow.png')); ?>";
                    var sad = "<?php echo e(asset('huycode/images/service/sad.png')); ?>";
                    var angry = "<?php echo e(asset('huycode/images/service/angry.png')); ?>";
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/service/facebook/facebook-v2.blade.php ENDPATH**/ ?>