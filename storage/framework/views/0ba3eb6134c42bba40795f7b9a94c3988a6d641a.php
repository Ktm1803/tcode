        ...
        <div class="h-full flex items-center">
            ...
            <div class="intro-x dropdown w-8 h-8">
                <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110"
                    ...
                    <img alt="Admin Lê Quốc Huy" src="<?php echo e(asset('huycode/images/users/user.png')); ?>">
                </div>
                <div class="dropdown-menu w-56">
                    <div class="dropdown-menu__content box bg-theme-11 dark:bg-dark-6 text-white">
                        <div class="p-4 border-b border-theme-12 dark:border-dark-3">
                            ...
                            <div class="text-xs text-theme-13 mt-0.5 dark:text-gray-600">
                                Số dư: <?php echo e(number_format(Auth::user()->money)); ?> đ
                            </div>
                        </div>
                        <div class="p-2">
    ...
    <!-- END: Top Bar -->
<?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>