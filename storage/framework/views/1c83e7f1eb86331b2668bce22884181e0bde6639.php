    ...
    <div class="nk-main ">
        <div class="nk-sidebar nk-sidebar-fixed is-light " data-content="sidebarMenu">
            <div class="nk-sidebar-element nk-sidebar-head">
                <div class="nk-sidebar-brand"><a href="<?php echo e(route('admin.index')); ?>"
                        ...
                        <ul class="nk-menu">
                            ...
                            <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item"><a href="<?php echo e(route('admin.service', 'facebook')); ?>"
                                            class="nk-menu-link"><span class="nk-menu-text">Dịch vụ facebook
                                            </span></a></li>
                                    <li class="nk-menu-item"><a href="<?php echo e(route('admin.service', 'instagram')); ?>" class="nk-menu-link"><span
                                                class="nk-menu-text">Dịch vụ instagram</span></a></li>
                                    <li class="nk-menu-item"><a href="<?php echo e(route('admin.service', 'tiktok')); ?>"
                ...
                <div class="container-fluid">
                    <div class="nk-header-wrap">
                        ...
                        <div class="nk-header-brand d-xl-none"><a href="index.html" class="logo-link"><img
                                    ...
                                    srcset="<?php echo e(asset('')); ?>images/logo2x.png 2x" alt="logo"><img
                                    class="logo-dark logo-img" src="images/logo-dark.png"
                                    srcset="<?php echo e(asset('')); ?>images/logo-dark2x.png 2x" alt="logo-dark"></a></div>
                                ...
                                <li class="dropdown user-dropdown"><a href="#" class="dropdown-toggle me-n1"
                                        ...
                                        <div class="user-toggle">
                                            ...
                                            <div class="user-info d-none d-xl-block">
                                                ...
                                                <div class="user-name dropdown-indicator"><?php echo e(Auth::user()->name); ?>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                                        <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                            <div class="user-card">
                                                ...
                                                <div class="user-info"><span
                                                        class="lead-text"><?php echo e(Auth::user()->name); ?></span><span
                                        ...
                                        <div class="dropdown-inner">
                                            <ul class="link-list">
                                                <li><a href="<?php echo e(route('home')); ?>"><em
...
<?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>