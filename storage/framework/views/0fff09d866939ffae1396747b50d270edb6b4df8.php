                ...
                <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                    <div class="flex items-center border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                        <div class="w-10 h-10 flex-none image-fit">
                            <img alt="Logo" class="rounded-full" src="<?php echo e(asset('huycode/images/users/user.png')); ?>">
                        </div>
                    ...
                    <div class="p-5">
                        <div class="h-40 2xl:h-56 image-fit">
                            <img alt="Logo Wallet" class="rounded-md m-auto" src="<?php echo e($item->logo); ?>"
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <a class="text-danger"
                                        ...
                                        href="javascript:;" onclick="coppy('stk<?php echo e($item->id); ?>');">
                                        <b id="stk<?php echo e($item->id); ?>"><?php echo e($item->account_number); ?></b>
                            ...
                            <tr>
                                ...
                                <td>
                                    <b style="color: blue ; margin-left: 10px"><?php echo e($item->account_name); ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <b style="margin-left: 10px"><?php echo e($item->bank_name); ?></b>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <a class="text-danger"
                                        ...
                                        <b
                                            id="transfer_code"><?php echo e($site_config->getValueByName('transfer_code')); ?><?php echo e(Auth::user()->id); ?></b>
                                        <i data-feather="copy" style="width: 18px"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <b class="text-danger"
                                        style="border: 2px dashed #e04f1a30; padding: 3px; color: #e53e3e !important; margin-left: 10px"><?php echo e(number_format($item->min_bank)); ?>
            ...
            <div class="p-4">
                <div class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative">
                    <table id="dataTable" class=" table-responsive border-collapse bg-white cust-datatable no-footer"
                        ...
                        <tbody class="p-4">
                            <?php $__currentLoopData = $huyMbbank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td style="text-align:center" class="p-4"><?php echo e($item->id); ?></td>
                                    <td style="text-align:center"><?php echo e($item->created_at); ?></td>
                                    <td style="text-align:center"><?php echo e($item->bank_name); ?></td>
                                    <td style="text-align:center"><?php echo e($item->transid); ?> </td>
                                    <td style="text-align:center"><?php echo e($item->thucnhan); ?></td>
                                    <td style="text-align:center"><?php echo e($item->noidung); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Huycode\resources\views/recharge/banking.blade.php ENDPATH**/ ?>