...
<head>
    ...
    <!-- STYLE CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>temp-order/css/app.css" />
...
<body class="login">
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    <img alt="image" class="-intro-x w-1/2 -mt-16"
                        src="<?php echo e(asset('')); ?>huycode/images/illustration.svg">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                        ADSCODE.NET
                    </div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-gray-500">ADSCODE là đơn vị
                        hàng
            ...
            <form action="<?php echo e(route('auth.login.post')); ?>" method="post">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-auto xl:my-0 ">
                    <div
                        class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto mt-20">
                        <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">
                            Đăng Nhập
                        </h2>
                        <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">ADSCODE là đơn vị hàng đầu Việt
                            Nam
                            chuyên
                            cung cấp các dịch vụ seeding tăng Like , Share , Comment , Follow... cho các Mạng xã hội như
                            Facebook ,
                            Instagram , Tiktok ...
                        </div>
                        <div class="intro-x mt-8">
                            <?php if(session('error')): ?>
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <span class="alert-inner--text"><?php echo e(session('error')); ?></span>
                            ...
                            <?php elseif(session('success')): ?>
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <span class="alert-inner--text"> <?php echo e(session('success')); ?></span>
                                    <button type="button" class="btn-close" style="top: 7px" data-bs-dismiss="alert"
                                        aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                            ...
                            <?php endif; ?>
                            <input type="text" name="username" id="username" value="<?php echo e(Request::old('username')); ?>"
                        ...
                        <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                            <div class="flex items-center mr-auto">
                                <input id="remember_me" name="remember_me" type="checkbox"
                                    class="form-check-input border mr-2" value="1">
                                <label class="cursor-pointer select-none" for="remember_me">Nhớ tài khoản</label>
                            </div>
                            <a href="https://fb.com/lqh.coder">Quên mật khẩu?</a>
                        </div>
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button type="submit"
                                class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Đăng nhập
                            </button>
                            <a class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top"
                                href="<?php echo e(route('auth.register')); ?>">Đăng kí</a>
                        </div>
                        <div class="intro-x mt-10 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left">
                            Bằng việc đăng nhập, bạn đã đồng ý với
                            <br>
                            <a class="text-theme-17 dark:text-gray-300" href="">Điều khoản và điều kiện</a> & <a
                                class="text-theme-17 dark:text-gray-300" href="">Chính sách bảo mật của chúng
                                tôi</a>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?php echo e(asset('')); ?>huycode/js/app.js"></script>

    <!-- END: JS Assets-->
</body>

</html>
<?php /**PATH C:\xampp1\htdocs\Huycode\Huycode\resources\views/auth/login.blade.php ENDPATH**/ ?>